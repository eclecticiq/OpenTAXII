...
def parse_content_binding(raw_content_binding, version):
    if version == 10:
        ...
        return ContentBindingEntity(binding=raw_content_binding.binding_id,
...
def content_binding_entity_to_content_binding(content_binding, version):
    if version == 10:
        ...
        return tm11.ContentBinding(binding_id=content_binding.binding, subtype_ids=content_binding.subtypes)
...
def poll_service_to_polling_service_instance(service, version, poll_instance_cls=False):
...
def content_block_entity_to_content_block(entity, version):
    ...
    content_bindings = content_binding_entity_to_content_binding(entity.content_binding, version=version)
